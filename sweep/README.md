...
1,505 inputs, each with org's own answer stored beside it. Run automatically by `swift test`
...
"1,505 inputs, 0 mismatches" is **not a correctness proof** and must never be quoted as one.
